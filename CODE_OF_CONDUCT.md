...
3.  **Stereotyping or discrimination.** Characterising anyone's personality or
    behaviour on the basis of immutable identities or traits.
4.  **Sexualisation.** Behaving in a way that would generally be considered
...
4.  **Irresponsible communication.** Failing to responsibly present content
    which includes, links or describes any other restricted behaviours.
...
The maintainer takes reports of violations seriously and will investigate all
reports, reviewing messages, logs, or other relevant evidence. Investigations
and enforcement actions will be kept as transparent as possible while
prioritising safety and confidentiality.
...
based on the incident's impact. Depending on the severity, lower rungs may be
skipped.

1.  **Warning.** A private, written warning for a single incident or series of
    incidents.
2.  **Temporarily limited activities.** A time-limited cooldown period
    restricted to particular communication channels or interactions.
3.  **Temporary suspension.** A private written warning with conditions for
    return from suspension.
4.  **Permanent ban.** Access to all community spaces, tools, and communication
    channels is removed.

This enforcement ladder is intended as a guideline. It does not limit the
ability of the maintainer to use their discretion and judgment in keeping with
