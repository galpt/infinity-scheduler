...
├── patches/
│   ├── arch/6.18/            33 patches — Vanilla kernel.org 6.18
│   ├── arch/7.0/             32 patches — Vanilla kernel.org 7.0
│   ├── arch/7.1/             32 patches — Vanilla kernel.org 7.1
│   ├── arch/7.2/             22 patches — Vanilla kernel.org 7.2 (7.2-rc6 base)
│   └── fedora/7.0/           33 patches — Fedora kernel-ark archived-7.0
