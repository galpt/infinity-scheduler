...
├── patches/
│   ├── arch/6.18/            16 patches — Vanilla kernel.org 6.18
│   ├── arch/7.0/             16 patches — Vanilla kernel.org 7.0
│   ├── arch/7.1/             16 patches — Vanilla kernel.org 7.1
│   └── fedora/7.0/           16 patches — Fedora kernel-ark archived-7.0
