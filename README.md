...
├── patches/
│   ├── arch/6.18/            15 patches — Vanilla kernel.org 6.18
│   ├── arch/7.0/             15 patches — Vanilla kernel.org 7.0
│   ├── arch/7.1/             15 patches — Vanilla kernel.org 7.1
│   └── fedora/7.0/           15 patches — Fedora kernel-ark archived-7.0
